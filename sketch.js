...
function feedDog(){
   dog.addImage(happyDog);
    ...
    }else{ foodObj.updateFoodStock(food_stock_val -1); } database.ref('/').update({
...
/* I am confused about how to make the last fed time work. Can you help?

I looked up the answer to how to feed the dog, but I don't understand how it works. Can you explain?*/